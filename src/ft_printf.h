...
/*   Updated: 2022/01/07 21:27:47 by eestelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_putchar(va_list data, __attribute__((unused)) t_flag *flag);
int	ft_putstr(va_list data, __attribute__((unused)) t_flag *flag);
int	ft_putadd(va_list data, t_flag *flag);
int	ft_putdigit(va_list data, t_flag *flag);
int	ft_putudigit(va_list data, __attribute__((unused)) t_flag *flag);
